...
## Visión general
El bloque HW es un kernel de contracción TT orientado a acelerar capas lineales comprimidas en Tensor-Train (TT). El objetivo es ejecutar el kernel de contracción TT en streaming con control por AXI4-Lite y transferencia de datos por AXI-Stream/DMA.
